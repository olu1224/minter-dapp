const contractAddress = "0xb1422d37050aC5f3aa41F9997634040fBA74e938"; //Replace with your own contract address
const chain = 'rinkeby'; // rinkeby or polygon

const welcome_h1 = "Welcome to the Snacking Bunnies Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The Snacking Bunnies NFT Project is a decentralized, open-source project that aims to demonstrate how to develope and launch your own NFT Collection. Follow step by step on the <a href="https://youtube.com/codestackr"  target="_blank" rel="noopener noreferrer">codeSTACKr</a> YouTube channel.';
